  ...
  render() {
    ...
    return (
      <View style={styles.VideoContainer}>
        ...
        >
          <Image source={{ uri: data.thumb }} style={styles.thumbnail} />
          <View style={styles.play}>
            <Image
              source={require("../../images/视频.png")}
        ...
        <View style={styles.BottomContainer}>
          <TouchableOpacity onPress={this.addActive}>
            <View style={styles.BottomLeftContainer}>
              <Icon
                name={this.state.voted ? "ios-heart" : "ios-heart-empty"}
                size={30}
                color="red"
              />
  ...
  renderLoadingView() {
    return (
      <View style={styles.LoadingContainer}>
        <ActivityIndicator animating={true} color="#bdc3c7" size="small" />
      </View>
    );
  }
  renderVideo({ item }) {
