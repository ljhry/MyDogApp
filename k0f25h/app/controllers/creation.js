...
function asyncMedia(videoId, audioId) {
  ...
  .then(function(data) {
    ...
    var videoURL = 'http://res.cloudinary.com/gougougg/video/upload/e_volume:-100/e_volume:400,l_video:' + audio_public_id + '/' + video_public_id + '.mp4'
    var thumbName = video_public_id.replace(/\//g, '_') + '.jpg'
    var thumbURL = 'http://res.cloudinary.com/gougougg/video/upload/' + video_public_id + '.jpg'
...
exports.save = function *(next) {
  ...
  if (!creation) {
    ...
    if (video_public_id && audio_public_id) {
      creationData.cloudinary_thumb = 'http://res.cloudinary.com/gougougg/video/upload/' + video_public_id + '.jpg'
      creationData.cloudinary_video = 'http://res.cloudinary.com/gougougg/video/upload/e_volume:-100/e_volume:400,l_video:' + audio_public_id.replace(/\//g, ':') + '/' + video_public_id + '.mp4'
